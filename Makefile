...
# TA-TODO: WorldsHardestEasiestGame
# This should be a just a name i.e MyFirstGBAProgram
# No SPACES AFTER THE NAME.
PROGNAME = WorldsHardestEasiestGame
...
OFILES = gba.o font.o main.o images/garbage.o images/welcome.o images/enemy.o images/win.o
